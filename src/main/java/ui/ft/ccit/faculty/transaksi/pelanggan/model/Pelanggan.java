...
public class Pelanggan {
    ...
    public Pelanggan(String idPelanggan, String nama, Character jenisKelamin, String alamat,
            String telepon, LocalDate tglLahir, Character jenisPelanggan) {
    ...
    public Character getJenisPelanggan() {
        return jenisPelanggan;
    }

    public void setJenisPelanggan(Character jenisPelanggan) {
        this.jenisPelanggan = jenisPelanggan;
    }
}
